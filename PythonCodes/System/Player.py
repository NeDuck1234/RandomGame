...
class Player:
    ...
    def move(self,event):
        value = None
        if event == self.keyCodes["up"]: value = [0,-1,0] 
        elif event ==  self.keyCodes["left"]: value = [1,-1,1]
        elif event ==  self.keyCodes["down"]: value = [0,1,2]
        elif event ==  self.keyCodes["right"]: value = [1,1,3]
        return value
